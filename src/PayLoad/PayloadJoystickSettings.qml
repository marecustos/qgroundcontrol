...
Window {
    ...
    property var buttonFunctionnalities : payloadBoard == "seabotx"? ["Y Rotation -1", "Docking -1" , "Docking +1", "Y Rotation +1" , "deployTransition +1" , "" , "deployTransition -1" , "Prob Z Transition +1" , "Prob Z Transition -1" , "Magnet" , "Brush" , "Prob Y Transition +1" , "Prob Y Transition -1", "Prob X Transition +1" , "Prob X Transition -1" , "Camera Rotation +1" , "Camera Rotation -1"]: payloadBoard=="seaboty" ? ["Y Rotation -1", "" , "", "Y Rotation +1" , "" , "" , "" , "" , "" , "Magnet" , "" , "" , "", "" , "" , "Camera Rotation +1" , "Camera Rotation -1"] : []
